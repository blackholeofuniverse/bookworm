...
const COLORS = {
  primary: "#4CAF50",          // Deep purple for primary actions
  textPrimary: "#E0E0E0",     // Light grey for primary text
  textSecondary: "#9E9E9E",   // Medium grey for secondary text
  textDark: "#FFFFFF",        // White for emphasis text
  placeholderText: "#757575", // Darker grey for placeholders
  background: "#121212",      // Material dark background
  cardBackground: "#1E1E1E",  // Slightly lighter than background
  inputBackground: "#2D2D2D", // Even lighter for input fields
